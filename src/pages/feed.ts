...
<body>
  ...
  <div class="lightbox" id="lightbox" role="dialog" aria-modal="true" aria-label="Enlarged profile photo" onclick="this.classList.remove('active')">
    <img src="${escapeHtml(settings?.profile_photo_url || '/alexandra.webp')}" alt="Alexandra Milak profile photo" width="800" height="691" loading="lazy" decoding="async">
  </div>
<script>
