...
<body>
  ...
  <main id="main-content" class="hero">
    <div class="banner-wrapper">
      <img src="${escapeHtml(settings.banner_url)}" alt="Sunday Sauce newsletter banner" class="banner" width="1800" height="1350" fetchpriority="high" decoding="async">
      <img src="${escapeHtml(settings.profile_photo_url)}" alt="Alexandra Milak" class="profile-photo" width="800" height="691" decoding="async">
    </div>
