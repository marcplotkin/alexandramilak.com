  ...
  const content = `
    <div style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; padding: 0;">
      <div style="width: 100%; max-width: 680px; margin-bottom: 32px;">
        <img src="/tomatoes.webp" alt="Tomatoes" width="1800" height="1350" fetchpriority="high" decoding="async" style="width: 100%; height: 180px; object-fit: cover; border-radius: 0 0 20px 20px; display: block;">
      </div>
